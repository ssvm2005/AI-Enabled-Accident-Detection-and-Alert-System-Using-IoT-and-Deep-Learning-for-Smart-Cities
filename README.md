...
📊 Results
Successfully detected impact conditions
GPS coordinates matched real-world location
SMS alerts delivered reliably
End-to-end system tested on hardware
🧠 What I Learned (IMPORTANT for interviews)
Sensor fusion using IMU + FSR
Threshold-based real-time decision systems
UART communication between Arduino and Raspberry Pi
Deploying lightweight ML models (TFLite) on edge devices
